 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Shift|   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |  Up  |RS/Ent|
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | GUI  | Alt  | Clip |Lower |Space | Bksp |Raise |   /  | Left | Down |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_GAMING] = LAYOUT( \
  ...
  KC_LCTL, KC_LGUI, KC_LALT, M_CLIP,  LOWER,   KC_SPC,  KC_BSPC, RAISE,   KC_SLSH, KC_LEFT, KC_DOWN, KC_RGHT \
),
 ...
 */
[_NUMPAD] =  LAYOUT( \
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_DLR,  XXXXXXX, KC_PSLS, KC_PAST, KC_PMNS, KC_BSPC, \
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_PERC, KC_P7,   KC_P8,   KC_P9,   KC_PPLS, KC_BSPC, \
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_CIRC, KC_P4,   KC_P5,   KC_P6,   KC_PPLS, KC_BSPC, \
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_EQL,  KC_P1,   KC_P2,   KC_P3,   KC_PENT, KC_BSPC, \
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, ADJUST,  XXXXXXX, KC_SPC,  KC_P0,   KC_P0,   KC_PDOT, KC_PENT, KC_BSPC \
),
 ...
 * |      |      |      |      |  F5  |      |      |PgDwn | PgUp |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      | C-S  |      |Enter |      | Left | Down |  Up  |Right | Bksp | Esc  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      | C-C  | C-V  |      |      |      |      |C-Bksp|      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |GUI-S |      |      |      |      |      |      |
...
[_EXTEND] =  LAYOUT( \
  ...
  _______, _______, C(KC_S), _______, KC_ENT,  _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_BSPC,    KC_ESC, \
  _______, _______, _______, _______, C(KC_C), C(KC_V), _______, _______, _______, _______, C(KC_BSPC), _______, \
  _______, _______, _______, _______, _______, G(KC_S), _______, _______, _______, _______, _______,    _______ \
),
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    case M_CLIP:
      if (record->event.pressed) {
          SEND_STRING(SS_DOWN(X_LGUI) SS_DOWN(X_LALT) SS_TAP(X_G) SS_UP(X_LALT) SS_UP(X_LGUI));
      }
      break;
  }
  return true;
